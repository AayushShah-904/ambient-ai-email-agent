# test_calendar_real.py - FULL TEST + generate_reply_llm INTEGRATION
import os
import sys
...
from src.tools.calendar import (
    ...
    generate_reply_llm  # 🔥 YOUR NEW FUNCTION
)
from src.tools.gmail import send_reply  # For real send
...
if details and 'slots' in details and details['slots']:
    ...
    # 🔥 GENERATE REPLY LLM (YOUR NEW FUNCTION!)
    print("\n✨ Smart LLM Reply:")
    sender = "aayushshah90421@gmail.com"  # Mock
    ...
    reply_text = generate_reply_llm(sample_email["subject"], sample_email["body"])
